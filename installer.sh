...
curl -O /var/volatile/tmp/BoHLALA_FHD.tar.gz "https://github.com/BoHLALA/Data/raw/main/BoHLALA_FHD.tar.gz"
curl -O /var/volatile/tmp/byBO-HLALA_authorskin-V_2.2.tar.gz "https://github.com/BoHLALA/Data/raw/main/byBO-HLALA_authorskin-V_2.2.tar.gz"
curl -O /var/volatile/tmp/addons1.tar.gz "https://github.com/BoHLALA/Data/raw/main/addons1.tar.gz"
curl -O /var/volatile/tmp/addons2.tar.gz "https://github.com/BoHLALA/Data/raw/main/addons2.tar.gz"
