...
wget -O /var/volatile/tmp/BoHLALA_app.tar.gz --no-check-certificate "https://github.com/BoHLALA/skins/raw/main/BoHLALA_app.tar.gz"
wget -O /var/volatile/tmp/BoHLALA_FHD_V2.2.tar.gz --no-check-certificate "https://github.com/BoHLALA/skins/raw/main/BoHLALA_FHD_V2.2.tar.gz
