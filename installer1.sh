...
#########################################################
version= 2.2
description=   Developed By Bo.HLALA .. ^_^
#########################################################
#########################################################
...
wget -O /var/volatile/tmp/BoHLALA_FHD_V2.2.tar.gz --no-check-certificate "https://github.com/BoHLALA/Scripts/refs/heads/K.S.A/BoHLALA_FHD_V2.2.tar.gz"
